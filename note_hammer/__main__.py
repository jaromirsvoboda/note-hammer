...
def extract_kindle(input_path: str, output_path: str, backup_path: str, overwrite_older_notes: bool, skip_confirmation: bool):
    ...
    note_hammer.extract_kindle_notes(input_path=input_path, output_path=output_path, overwrite_older_notes=overwrite_older_notes, skip_confirmation=skip_confirmation)
