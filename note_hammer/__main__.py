...
@click.argument('--tags', nargs=-1) # TODO argument or option?
@click.option('-sc', '--skip_confirmation', is_flag=True, help='Confirm before processing the notes.')
def extract_kindle(input_path: str, output_path: str, backup_path: str, tags: list[str], skip_confirmation: bool):
